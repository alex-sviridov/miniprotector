...
type ChunkHash struct {
	...
	Checksum      uint32                 `protobuf:"varint,5,opt,name=checksum,proto3" json:"checksum,omitempty"` // CRC32-IEEE of chunk data, for file-level integrity
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChunkHash) GetChecksum() uint32 {
	if x != nil {
		return x.Checksum
	}
	return 0
...
const file_api_backup_proto_rawDesc = "" +
	...
	"\x03eof\x18\x04 \x01(\bR\x03eof\x12\x1a\n" +
	"\bchecksum\x18\x05 \x01(\rR\bchecksum\"[\n" +
	"\tChunkData\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\x12\x14\n" +
	"\x05index\x18\x02 \x01(\x03R\x05index\x12\x12\n" +
